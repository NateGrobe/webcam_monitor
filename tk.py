...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.sidebar_button_1 = customtkinter.CTkButton(self.sidebar_frame, text="Check stats", command=self.sidebar_button_event)
        ...
        self.scrollable_frame = customtkinter.CTkScrollableFrame(self, label_text="Apps With Access")
